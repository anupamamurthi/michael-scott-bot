...
openai_api_key = openai_api_key_1 or openai_api_key_2

# load daataset
dataset = load_dataset("jxm/the_office_lines")
train = dataset["train"]
df_train = pd.DataFrame(train) 
df_train_scott_lines = df_train["Michael" == df_train["speaker"]]
filtered_df = df_train_scott_lines[df_train_scott_lines['line_text'].str.len() > 25]
